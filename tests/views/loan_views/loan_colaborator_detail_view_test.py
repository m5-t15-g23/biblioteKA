...
class LoanColaboratorDetailViewTest(APITestCase):
    ...
    def setUpTestData(cls) -> None:
        ...
        cls.BASE_URL = f"/api/loans/student/{cls.student.id}/"

    def test_if_non_authenticated_user_cant_list_students_loans(self):
    ...
    def test_if_student_cant_list_students_loans(self):
    ...
    def test_if_a_colaborator_can_list_all_loans_by_student_id(self):
        self.client.credentials(
